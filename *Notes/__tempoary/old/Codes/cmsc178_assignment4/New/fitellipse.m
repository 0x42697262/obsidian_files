...
% FREE TO EXPERIMENT WITH IT - NOTE HOWEVER THAT THESE VALUES ARE NOT IN THEMSELVES
% INVARIANTm BUT THE RATIO OF Rx TO Ry IS. ALSO USE THIS ON THE OUTLINE NOT THE
% SOLID BINARY MASK. - DG.
%
if nargin == 0
  % Create an ellipse
  t = linspace(0,2);
